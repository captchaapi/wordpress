 ...
 * widget's submit mode can attach an attestation. A capture-phase listener
 * intercepts the first submit of any form matching a configured selector,
 * fetches a fresh attestation through window.captchaapi.solve(), writes it into
 * a hidden field, and re-submits. The second pass runs the plugin's own handler,
 * which serializes the form with the attestation included.
 *

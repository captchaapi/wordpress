...
(function () {
    ...
    // These forms are never marked with data-captcha, so the widget does not
    // find them on its own - the badge is attached here and put into standby,
    // and every state after that arrives through solve({ form }).
    function badge() {
        var match = selector();
